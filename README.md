...
### 1.3 硬件
🔴本文实测使用**联想Y7000p，4060m 8G显存，14代i7CPU,内存16GB**；后来研究了各种小主机，发现了**目前市场上性价比最高的小主机铭凡8745（8745的马甲是255H；比8845只少了现在不实用的NPU）Slim32G DDR5-5600+1T硬盘国补只要2500元左右（iGPU核显780m达到N卡1060-2060水平，对标Intel Ultra5二代225H了；BIOS可设最大16G显存+8G共享显存,大量测试表明qwen3-30b-a3b-Q4模型可以达到15-25tokens/s的能用程度，不过都是用LMStudio因为Ollama只有在Linux下才支持RCom加速且不是所有型号都支持）**<BR>
...
🟥2、现在如果要新配一台机器跑本地大模型的话，目前性价比最高的机器应该就是铭凡8745Slim小主机32G DDR5-5600+1T硬盘国补只要2500元左右（iGPU核显780m达到N卡1060-2060水平，对标Intel Ultra5二代225H了；BIOS可设最大16G显存+8G共享显存,大量测试表明qwen3-30b-a3b-Q4模型可以达到15-25tokens/s的能用程度，不过都是用LMStudio因为Ollama只有在Linux下才支持RCom加速且不是所有型号都支持）<BR>
